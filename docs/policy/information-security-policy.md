...
- Course: CCCS-453-764 - Security Risk, Management & Governance
- Term: Winter 2026
- Student: Hichem Benzaïr
- Professor: Nagi Basha

## 1. Introduction
This document is an academic project deliverable prepared for McGill University (CCCS-453-764) and is not an official policy issued by Desjardins Insurance. The organization name is used as a case-study example for educational purposes.

This policy defines the commitment of Desjardins Insurance to establish, implement, maintain, and continually improve an information security program aligned with ISO/IEC 27001:2022. It sets the high-level direction, principles, and mandatory requirements for protecting the confidentiality, integrity, and availability of information assets that support insurance operations and the personal information of clients, employees, and partners.
